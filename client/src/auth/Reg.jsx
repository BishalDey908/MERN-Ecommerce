...
const Reg = () => {
    ...
    const handleSubmit = (e) =>{
        ...
        axios.post(`${import.meta.env.VITE_KEY}reg`,{username,email,password})
        .then((e)=>{
            console.log(e)
            if(e.data){
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Already have an account? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={take}>Login here</a>
                  </p>
              </form>
          </div>
      </div>
