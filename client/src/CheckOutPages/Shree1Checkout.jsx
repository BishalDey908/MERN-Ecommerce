...
const Shree1Checkout = () => {
    const navigate=useNavigate()

    function adressform(){
        navigate("/adressformshree1")
    }
  return (
    <>
     <Navbar />
        ...
        <div className="grid max-w-3xl grid-cols-1 mx-auto mt-8 text-center sm:mt-16 sm:text-left sm:grid-cols-2 gap-y-8 gap-x-8 lg:gap-x-20">
            <div className="relative group ">
                <div className="overflow-hidden rounded-lg xl:w-96 w-80 h-[555px] mx-auto">
                    <img className="object-cover w-full h-full transition-all duration-300 transform group-hover:scale-125" src="https://www.bharatsthali.com/cdn/shop/products/rju1722_1_1800x1800.jpg?v=1624108477" alt="" />
                </div>
            ...
            <div className="xl:w-96 xl:mt-24 w-80">
                <h1 className="text-2xl font-extrabold">MUSTARD COLOR PURE COTTON PRINTED NARAYAN PETH HANDLOOM SAREE</h1>
                <br />
                <br />
